...
export const DASHBOARD_VIEWS: DashboardViewMeta[] = [
  ...
  { view: 'workloads', path: '/workloads', label: 'Workloads', breadcrumb: 'Workloads', subtitle: 'Deploy, monitor, and manage across Podman, Kubernetes & KubeVirt', group: 'primary', icon: Layers, paletteLabel: 'Workloads' },
