    ...
    >
      <div className="mb-4 flex flex-wrap gap-2" data-testid="graph-edge-filters">
        ...
        <button
          ...
          className="rounded-full border glass-divider px-3 py-1 text-xs text-muted"
      ...
      {graph ? (
        <>
          <div className="mb-4 grid gap-3 sm:grid-cols-5">
            <div className="tahoe-stat-tile rounded-[var(--radius-md)] border border-border bg-surface p-4"><div className="text-xl font-semibold text-foreground">{graph.stats.workloads}</div><div className="text-xs text-subtle">Workloads</div></div>
            <div className="tahoe-stat-tile rounded-[var(--radius-md)] border border-border bg-surface p-4"><div className="text-xl font-semibold text-foreground">{graph.stats.dependencies}</div><div className="text-xs text-subtle">Dependencies</div></div>
            <div className="tahoe-stat-tile rounded-[var(--radius-md)] border border-border bg-surface p-4"><div className="text-xl font-semibold text-foreground">{graph.stats.threats}</div><div className="text-xs text-subtle">Threats</div></div>
            <div className="tahoe-stat-tile rounded-[var(--radius-md)] border border-border bg-surface p-4"><div className="text-xl font-semibold text-foreground">{graph.stats.drifted}</div><div className="text-xs text-subtle">Drifted</div></div>
            <div className="tahoe-stat-tile rounded-[var(--radius-md)] border border-border bg-surface p-4"><div className="text-xl font-semibold text-foreground">{graph.stats.clusters}</div><div className="text-xs text-subtle">Clusters</div></div>
          </div>

          {graph.nodes.length === 0 ? (
            <p className="text-sm text-subtle">Deploy workloads to populate the knowledge graph.</p>
          ) : (
            <div
