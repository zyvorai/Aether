        ...
        <div className="mt-4 flex flex-wrap gap-2">
          {[
            ...
            <button
              ...
              className="rounded-full border glass-divider px-3 py-1 text-xs text-muted hover:border-primary/30 hover:text-foreground"
            >
              {sample}
            </button>
          ))}
          ...
          <>
            ...
            <div className="mt-4 flex flex-wrap gap-2">
              ...
              <button
                ...
                className="rounded-xl border glass-divider px-4 py-2.5 text-sm text-muted hover:border-primary/40"
              >
                Open in editor
              </button>
            </div>
