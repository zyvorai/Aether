...
export default function YamlInput({
  ...
  return (
    <div className={isEditor ? 'flex min-h-0 flex-1 flex-col gap-3 overflow-hidden' : 'space-y-3'}>
      ...
      {isEditor ? (
        <>
          ...
          <div className="relative min-h-0 flex-1 overflow-hidden">
            {editorLoading ? (
              <div className="glass-code-block absolute inset-0 z-10 flex items-center justify-center">
      ...
      <div className={`relative z-10 flex flex-wrap items-center justify-end gap-2 ${isEditor ? 'shrink-0 pt-2' : ''}`}>
