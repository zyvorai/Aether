  ...
  return (
    ...
    >
        ...
        <div data-testid="production-scorecard-panel">
          ...
          <ul className="space-y-1 text-sm">
            {scorecard.checks.map((c) => (
              <li key={c.label} className="flex justify-between text-slate-300">
                <span>{c.label}</span>
      ...
      {!loading && tab === 'auth' && auth ? (
        <div data-testid="production-auth-panel" className="text-sm text-slate-300 space-y-2">
      ...
      {!loading && tab === 'ops' && hosted ? (
        <div data-testid="production-ops-panel" className="text-sm text-slate-300 space-y-2">
