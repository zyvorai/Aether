      ...
      actions={
        <div className="flex flex-wrap gap-2">
          ...
          <button
            ...
            disabled={executing}
            className="rounded-xl border glass-divider px-3 py-2 text-xs text-muted hover:border-primary/40 disabled:opacity-60"
          >
            Dry-run remediation
          </button>
          <button
    ...
    >
      ...
      <div className="grid gap-6 lg:grid-cols-2">
        ...
        <div>
          ...
          <Link to={viewToPath('gitops')} className="mt-3 inline-block text-xs text-primary hover:underline">
            GitOps drift →
          </Link>
        </div>
      </div>
