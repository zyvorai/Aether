          ...
          <div className="glass rounded-[var(--radius-xl)] w-full max-w-lg p-8 text-center shadow-lg">
            ...
            <div className="flex items-center justify-center gap-3">
              ...
              <button
                ...
                className="flex items-center gap-2 px-4 py-2 text-sm font-medium rounded-lg bg-primary hover:bg-aether-light text-[var(--primary-foreground)] transition-colors"
              >
