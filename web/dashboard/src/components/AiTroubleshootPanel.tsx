                        ...
                        <div className="mt-2 flex flex-wrap gap-2">
                          {applyable && (
                            <button
                              ...
                              className="inline-flex items-center gap-1 rounded-lg bg-primary/20 px-3 py-1.5 text-xs font-medium text-primary hover:bg-primary/30 disabled:opacity-50"
