            ...
            <div className="mt-4 flex flex-wrap gap-2" data-testid="workload-quick-links">
              {(
                [
                  ...
                  { label: 'Templates', slug: 'templates', path: pathWithQuery(viewToPath('templates'), { q: workload.name }) },
                  { label: 'Alerts', slug: 'alerts', path: pathWithQuery(viewToPath('events'), { workload: workload.name }) },
