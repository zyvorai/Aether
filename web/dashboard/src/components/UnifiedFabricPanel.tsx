...
export default function UnifiedFabricPanel() {
  ...
  return (
    <section className="mb-8 surface-panel rounded-[28px] p-6 sm:p-8" data-testid="unified-fabric-panel">
      <div className="mb-4 flex items-center justify-between gap-3">
        <div className="flex items-center gap-3">
          <Box className="h-5 w-5 text-purple-400" />
          <div>
            <h2 className="text-xl font-semibold text-white">Unified Edge + Cloud Fabric</h2>
