...
const PARENT_CRUMBS: Partial<Record<AppView, { view: AppView; label: string }>> = {
  ...
  'conf-tee': { view: 'confidential', label: 'Confidential Computing' },
  'conf-trust': { view: 'confidential', label: 'Confidential Computing' },
  'conf-migrate': { view: 'confidential', label: 'Confidential Computing' },
  'conf-workloads': { view: 'confidential', label: 'Confidential Computing' },
