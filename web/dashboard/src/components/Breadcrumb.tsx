    ...
    <nav className="dash-breadcrumb mb-3" aria-label="Breadcrumb">
      <div className="flex min-w-0 flex-wrap items-center gap-0.5 px-1 py-1">
        <button
          ...
          className="inline-flex items-center gap-1.5 rounded-lg px-2 py-1 text-[13px] text-slate-400 transition hover:bg-white/[0.04] hover:text-slate-100 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-aether/40"
        >
        ...
        {explicitParent ? (
          <>
            ...
            <button
              ...
              className="truncate rounded-lg px-2 py-1 text-[13px] text-slate-400 transition hover:bg-white/[0.04] hover:text-slate-100"
            >
        ...
        {groupLabel ? (
          <>
            <ChevronRight className="h-3.5 w-3.5 shrink-0 text-slate-600" aria-hidden />
            <span data-testid="breadcrumb-group" className="truncate px-2 py-1 text-[13px] text-slate-500">
              {groupLabel}
            </span>
          </>
        ) : null}
        <ChevronRight className="h-3.5 w-3.5 shrink-0 text-slate-600" aria-hidden />
        <span className="truncate px-2 py-1 text-[13px] font-medium text-slate-100">{label}</span>
        {workload ? (
          <>
            <ChevronRight className="h-3.5 w-3.5 shrink-0 text-slate-600" aria-hidden />
            <button
              ...
              className="max-w-[12rem] truncate rounded-lg px-2 py-1 text-[13px] font-mono text-aether transition hover:bg-white/[0.04] hover:underline"
            >
              {workload}
            </button>
          </>
