  ...
  return (
    <div className="relative glass-table-row">
      <div className="pointer-events-none absolute inset-0 overflow-hidden" aria-hidden>
        ...
        <div className="hero-orb absolute -top-20 left-0 h-72 w-72 rounded-full bg-primary/14" />
      ...
      <div className="relative dash-content py-8 lg:py-10">
        <div className="grid gap-8 lg:grid-cols-[minmax(0,1fr)_auto] lg:items-end">
          <div className="w-full min-w-0">
            <div className="live-intelligence-badge mb-4 !border-primary/25 !bg-primary/10">
              <span className="live-intelligence-dot" />
              <span className="text-[11px] font-semibold uppercase tracking-[0.18em] text-primary">Control Plane</span>
            </div>
