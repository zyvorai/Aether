      ...
      <div className="relative">
        ...
        >
          {nonemptyFiltered.length === 0 ? (
            <span className="text-subtle" data-testid="log-viewer-empty">{emptyMessage}</span>
          ) : (
            filteredLogs.map((line, i) => (
              <div key={i} className="flex">
                <span className="mr-2 w-12 shrink-0 select-none border-r glass-divider pr-2 text-right text-subtle">
                  {i + 1}
                </span>
