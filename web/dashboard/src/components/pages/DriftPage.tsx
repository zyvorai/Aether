                    ...
                    driftResult?.workload_name === w.name
                      ...
                      : workloadFocus === w.name
                        ...
                        : bulkScan?.drifted.includes(w.name)
                          ...
                          : 'border-slate-800/60 bg-[#11151C] text-slate-200 hover:bg-slate-800/60/80'
                  }`}
                >
                  ...
                  <div>
                    ...
                    <div className="space-y-2 max-h-64 overflow-auto">
                      {driftResult.drifts.map((d, i) => (
                        <div key={i} className="bg-[#11151C] rounded-lg p-3 border border-slate-800/60">
                  ...
                  <div>
                    ...
                    <div className="space-y-2">
                      {driftResult.reconciliation_plan.map((step, i) => (
                        <div key={i} className="rounded-lg border border-slate-800/60 bg-[#11151C] p-3 text-sm">
