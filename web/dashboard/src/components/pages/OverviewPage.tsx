        ...
        <EmptyState
          ...
          action={
            <button
              type="button"
              onClick={() => void load()}
              className="inline-flex items-center gap-2 rounded-xl bg-primary px-4 py-2 text-sm font-medium text-[var(--primary-foreground)] hover:bg-primary/90 transition-colors"
            >
