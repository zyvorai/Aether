          ...
          {report.diagnoses.map((row) => (
            ...
            >
              ...
              <div className="mt-4 grid gap-4 lg:grid-cols-2">
                ...
                <div>
                  <div className="text-[10px] uppercase tracking-wider text-subtle">Recommendation</div>
                  <p className="mt-1 text-sm text-muted">{row.recommendation}</p>
                </div>
              </div>

              {row.evidence.length > 0 ? (
                <ul className="mt-3 space-y-1 glass-divider-t/60 pt-3 text-xs text-subtle">
