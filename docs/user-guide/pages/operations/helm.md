...
Install curated charts with a guided wizard
...
- Route / id: `/helm`
- Nav: **Operations → Helm App Store** (sidebar, command palette, or desktop nav)

## Operate from the console (UX)

1. Open `/helm` and wait for live data from Aether.
