...
Import Docker Compose into Aether workloads
...
- Route / id: `/compose`
- Nav: **Operations → Compose Import** (sidebar, command palette, or desktop nav)

## Operate from the console (UX)

1. Open `/compose` and wait for live data from Aether.
