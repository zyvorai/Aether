...
AI migration planner with risk analysis and strategy
...
- Route / id: `/migrations`
- Nav: **Intelligence → Migrations** (sidebar, command palette, or desktop nav)

## Operate from the console (UX)

1. Open `/migrations` and wait for live data from Aether.
