...
Validate workloads against policy rules
...
- Route / id: `/policy`
- Nav: **Intelligence → Policy Check** (sidebar, command palette, or desktop nav)

## Operate from the console (UX)

1. Open `/policy` and wait for live data from Aether.
