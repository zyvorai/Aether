...
Experimental AI-generated infrastructure artifacts
...
- Route / id: `/labs`
- Nav: **Resources → Labs** (sidebar, command palette, or desktop nav)

## Operate from the console (UX)

1. Open `/labs` and wait for live data from Aether.
