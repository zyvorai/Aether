...
Tenants, API keys, metering, and Stripe billing
...
- Route / id: `/hosted`
- Nav: **Resources → Hosted SaaS** (sidebar, command palette, or desktop nav)

## Operate from the console (UX)

1. Open `/hosted` and wait for live data from Aether.
