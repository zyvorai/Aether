...
Resource cost projections across runtimes
...
- Route / id: `/cost`
- Nav: **Intelligence → Cost Estimation** (sidebar, command palette, or desktop nav)

## Operate from the console (UX)

1. Open `/cost` and wait for live data from Aether.
