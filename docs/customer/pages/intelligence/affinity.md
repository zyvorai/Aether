...
Workload class affinity and runtime fit
...
- Route / id: `/affinity`
- Nav: **Intelligence → Runtime Affinity** (sidebar, command palette, or desktop nav)

## What you can do

1. Open `/affinity` and wait for live data from Aether.
