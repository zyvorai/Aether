...
Platform, environments, secrets, and extensions
...
- Route / id: `/settings`
- Nav: **Resources → Settings** (sidebar, command palette, or desktop nav)

## What you can do

1. Open `/settings` and wait for live data from Aether.
