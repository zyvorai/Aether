...
Form-based workload designer (no YAML required)
...
- Route / id: `/editor`
- Nav: **Operations → Visual Editor** (sidebar, command palette, or desktop nav)

## What you can do

1. Open `/editor` and wait for live data from Aether.
