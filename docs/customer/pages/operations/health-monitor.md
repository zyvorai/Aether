...
Workload health checks and status
...
- Route / id: `/health-monitor`
- Nav: **Operations → Health Monitor** (sidebar, command palette, or desktop nav)

## Operate from the console (UX)

1. Open `/health-monitor` and wait for live data from Aether.
