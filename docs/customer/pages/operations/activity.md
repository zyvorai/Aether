...
CPU, memory, restarts, and errors across the fleet
...
- Route / id: `/activity`
- Nav: **Operations → Activity Monitor** (sidebar, command palette, or desktop nav)

## What you can do

1. Open `/activity` and wait for live data from Aether.
