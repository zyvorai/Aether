...
Notification channels, alert rules, and webhook tests
...
- Route / id: `/alerts`
- Nav: **Operations → Alerts** (sidebar, command palette, or desktop nav)

## What you can do

1. Open `/alerts` and wait for live data from Aether.
