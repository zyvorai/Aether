...
Scheduling recommendations and placement
...
- Route / id: `/scheduler`
- Nav: **Operations → Scheduler** (sidebar, command palette, or desktop nav)

## What you can do

1. Open `/scheduler` and wait for live data from Aether.
