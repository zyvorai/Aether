...
Enterprise SSO is provided via **OIDC** (`AETHER_OIDC_*`) and **SAML** (`AETHER_SAML_*`). For local/CI testing, set `AETHER_MOCK_IDP=1` to embed a mock IdP.
