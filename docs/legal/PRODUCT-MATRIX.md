...
**Trademarks** are not granted by the proprietary license, and Apache License 2.0 §6 explicitly excludes a trademark grant too — see [TRADEMARK-NOTICE.md](TRADEMARK-NOTICE.md). Anyone forking or redistributing Aether-core may not use the "Aether" or "Zyvor" names/logos to imply endorsement.

**Third-party dependencies** in builds may use their own licenses; see [PROPRIETARY-POLICY.md](PROPRIETARY-POLICY.md).

IP ownership: **ZyvorAI Labs Private Limited** unless assigned otherwise in writing.
