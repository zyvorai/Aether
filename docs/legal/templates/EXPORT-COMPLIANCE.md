...
**Incorporated into:** MSA / Order Form

---

## 1. Export-controlled technology
...
- Will not export, re-export, or transfer the Software or technical data in violation of applicable law;
- Will obtain all required government licenses before deployment in regulated or government/military contexts.
...
- In violation of sanctions targeting specific persons, entities, or regions.
...
**Restricted countries / entities list:** Maintain as Exhibit — counsel to update periodically.
