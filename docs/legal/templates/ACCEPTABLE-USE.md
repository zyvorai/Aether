...
**Applies to:** All Zyvor Software and Hosted Services  
...
3. Distribute malware, conduct fraud, or facilitate illegal surveillance of individuals without lawful basis.
4. Use cryptographic or attestation features to evade lawful export or sanctions requirements.
5. Resell, time-share, or offer the Software as a service bureau without a written agreement.
6. Scrape or overload Hosted Services beyond documented rate limits.
